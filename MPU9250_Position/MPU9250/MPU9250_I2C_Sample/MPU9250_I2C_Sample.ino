...
void loop()
{
  ...
  Serial.printf("%.3f", IMU.getAccelX_mss());
  Serial.printf(", ");
  Serial.printf("%.3f", IMU.getAccelY_mss());
  Serial.printf(", ");
  Serial.printf("%.3f", IMU.getAccelZ_mss());
  Serial.printf(", ");

  Serial.printf("%.3f", IMU.getGyroX_rads());
  Serial.printf(", ");
  Serial.printf("%.3f", IMU.getGyroY_rads());
  Serial.printf(", ");
  Serial.printf("%.3f\n", IMU.getGyroZ_rads());
